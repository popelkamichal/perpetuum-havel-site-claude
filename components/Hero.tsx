  ...
  return (
    <section className="w-full px-4 pb-20 pt-4">
      <div className="max-w-5xl mx-auto text-center">
        {/* Big title */}
        <h1
          className="font-bebas leading-[0.9] tracking-tight uppercase mb-8 select-none"
        ...
        {/* Subtitle */}
        <p className="text-[#666] font-inter text-xs md:text-sm max-w-md mx-auto mb-10 leading-relaxed">
