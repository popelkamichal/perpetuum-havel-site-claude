    ...
    <main className="min-h-screen bg-[#080808]">
      ...
      <article className="max-w-2xl mx-auto px-6 pb-20 -mt-16 relative z-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <Link href="/" className="text-[9px] tracking-[0.3em] uppercase font-din hover:opacity-70 transition-opacity duration-200" style={{ color: "#00ac93" }}>
            ← Zpět
          </Link>
        </div>

        {/* Titulek */}
        <h1 className="text-white font-din font-bold leading-tight mb-3"
            style={{ fontSize: "clamp(1.75rem, 5vw, 2.75rem)" }}>
          {tema}
        </h1>

        {/* Autor */}
        <p className="font-din text-[11px] tracking-[0.2em] uppercase mb-6" style={{ color: "#00ac93" }}>
          {autor}
        </p>

        {/* Perex */}
        <p className="font-din text-lg md:text-xl leading-relaxed mb-8 text-[#bbb]">
          {perex}
        </p>
        ...
        {/* Tělo */}
        <div className="space-y-5 text-[#888] font-din text-base md:text-[17px] leading-relaxed">
          {children}
        </div>
