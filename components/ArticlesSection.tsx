  ...
  return (
    <div className="bg-white p-5 mb-[3px] group cursor-pointer hover:bg-gray-50 transition-colors duration-200">
      <div className="flex justify-between items-start mb-3">
        <span
          className="text-[9px] tracking-[0.3em] uppercase font-din font-semibold"
          style={{ color: "#00ac93" }}
        >
          {category}
        </span>
      ...
      <h3 className="text-[#111111] font-din font-bold text-[13px] leading-snug mb-3 uppercase tracking-wide">
        {title}
      </h3>
      <p className="text-[#777] font-din text-[11px] leading-relaxed mb-4">
        {description}
      </p>
      <a
        href="#"
        className="text-[9px] tracking-[0.25em] uppercase font-din text-[#aaa] group-hover:text-[#00ac93] transition-colors duration-200"
      >
        Číst dál →
      </a>
    </div>
